...
import { PageInfosContext } from "../generalPurpose/pageInfosContext";
      ...
      <div style={{ display: "grid", gridTemplateColumns: "3fr 2fr", gap: 16 }}>
        ...
        <div style={{ border: "1px solid #E9ECEF", borderRadius: 8, padding: "12px 16px", background: "#fff" }}>
          ...
          {predictionSource === "model" ? (
            <WorkspaceFilePicker
              label="Base Model Source Architecture"
              kind="model"
              currentValue={med3pa_params.base_model?.id}
              onChange={(value) => setTop("base_model", value)}
          ...
          <WorkspaceFilePicker
            ...
            onChange={(value) => setTop("chosen_dataset", value)}
...
+                </label>
              ...
              <div>
                <label style={{ fontSize: 11, color: "#6C757D", display: "block", marginBottom: 2 }}>min_samples_leaf <Hint text={HINTS.gridMinSamplesLeaf} /></label>
                <input
                  type="text"
          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              <div>
                <label style={{ fontSize: 11, color: "#6C757D", display: "block", marginBottom: 2 }}>min_samples_leaf <Hint text={HINTS.apcMinSamplesLeaf} /></label>
                <input
                  type="number"
                  placeholder="e.g. 5"
                  style={{ width: "100%", boxSizing: "border-box", height: 28 }}
              ...
              <div>
                <label style={{ fontSize: 11, color: "#6C757D", display: "block", marginBottom: 2 }}>ccp_alpha <Hint text={HINTS.apcCcpAlpha} /></label>
                <input
                  type="number"
                  step={0.001}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              <div>
                <label style={{ fontSize: 11, color: "#6C757D", display: "block", marginBottom: 2 }}>max_depth <Hint text={HINTS.gridMaxDepth} /></label>
                <input
                  type="text"
                  placeholder="e.g. 2, 3, 4, 5"
                  style={{ width: "100%", boxSizing: "border-box", height: 28 }}
          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 8 }}>
              <div>
                <label style={{ fontSize: 11, color: "#6C757D", display: "block", marginBottom: 2 }}>min <Hint text={HINTS.samplesRatioMin} /></label>
                <input
                  type="number"
                  style={{ width: "100%", boxSizing: "border-box", height: 28 }}
              ...
              <div>
                <label style={{ fontSize: 11, color: "#6C757D", display: "block", marginBottom: 2 }}>max <Hint text={HINTS.samplesRatioMax} /></label>
                <input
                  type="number"
                  style={{ width: "100%", boxSizing: "border-box", height: 28 }}
              ...
              <div>
                <label style={{ fontSize: 11, color: "#6C757D", display: "block", marginBottom: 2 }}>step <Hint text={HINTS.samplesRatioStep} /></label>
                <input
                  type="number"
                  style={{ width: "100%", boxSizing: "border-box", height: 28 }}
